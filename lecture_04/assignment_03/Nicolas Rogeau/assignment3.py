...
def calculate_ik(robot, frame):
    ...
    start_configuration = Configuration.from_revolute_values([0, -1, 1, -1, -1, 0])
...
def store_configurations(configurations):
    ...
    path = os.path.abspath(os.path.join(here, "configurations.json"))
    
    #convert list of configurations to list of dictionaries
    configuration_list =[]
