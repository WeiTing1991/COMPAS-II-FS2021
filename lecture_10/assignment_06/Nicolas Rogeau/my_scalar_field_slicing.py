...
DATA_PATH = os.path.join(os.getcwd(), 'data') # For some reasons... I had to change os.path.dirname(__file__) to os.getcwd() to get a path...
...
if __name__ == '__main__':
    ...
    # Create scalar field
    plane = Plane(Point(0, 0, -500), Vector(0, 2, 1))
